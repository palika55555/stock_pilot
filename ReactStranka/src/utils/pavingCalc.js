/** m² → kusy, zaokrúhlenie nahor na celú vrstvu (rovnako ako Flutter). */
export function pavingCalcFromM2(requestedM2, stone) {
  ...
  if (!(requestedM2 > 0) || !piecesPerLayer || !layersPerPallet || !len || !wid) return null
