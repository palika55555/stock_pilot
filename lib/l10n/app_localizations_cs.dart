...
class AppLocalizationsCs extends AppLocalizations {
  ...
  @override
  String get bulkReceiptImport => 'Hromadný příjem';

  @override
  String get importPreview => 'Náhled importu';

  @override
  String matchedRowsCount(int count) {
    return 'Shodné s produkty: $count';
  }

  @override
  String unmatchedRowsCount(int count) {
    return 'Neshodné řádky: $count';
  }

  @override
  String get createDraftReceipt => 'Vytvořit rozpracovanou příjemku';

  @override
  String get importSuccess =>
      'Příjemka vytvořena. Můžete ji upravit a schválit.';

  @override
  String get selectExcelFile => 'Vyberte soubor Excel (.xlsx)';

  @override
  String get excelFormatHint =>
      'Sloupce: PLU (nebo Kód), Množství, MJ, Cena. První řádek může být hlavička.';

  @override
  String get noRowsMatched => 'Žádný řádek se neshodoval s produkty v systému.';

  @override
  String get importError => 'Chyba importu';

  @override
  String get downloadImportTemplate => 'Stáhnout šablonu importu';

  @override
  String get downloadImportTemplateSuccess =>
      'Šablona připravena k uložení nebo sdílení.';

  @override
  String get importSummaryTitle => 'Kontrola a souhrn';

  @override
  String importTotalRowsInFile(int count) {
    return 'Řádků v souboru: $count';
  }

  @override
  String importSkippedRows(int count) {
    return 'Řádků vynecháno: $count';
  }
  ...
  @override
  String get importWarnings => 'Varování';

  @override
  String get importExistingProducts => 'Existující produkty';

  @override
  String get importNewProducts => 'Nové produkty (budou vytvořeny)';

  @override
  String get importFullTable => 'Kompletní tabulka produktů';

  @override
  String get importStatusExisting => 'Existující';

  @override
  String get importStatusNew => 'Nový';

  @override
  String get importSupplierLabel => 'Dodavatel pro příjemku';

  @override
  String get importWarehouseLabel => 'Sklad pro nové produkty';

  @override
  String get importOptionalNone => '— Nevybrat';
  ...
  @override
  String get importPriceSaleWithoutVat => 'Prodej bez DPH';

  @override
  String get importPriceSaleWithVat => 'Prodej s DPH';

  @override
  String get importVatSale => 'DPH prodej %';

  @override
  String get updateAvailableTitle => 'Je k dispozici nová verze';

  @override
  String updateAvailableBody(String version, String current) {
    return 'Je k dispozici verze $version (aktuální: $current).';
  }
  ...
  @override
  String get monthlyClosingsTitle => 'Měsíční uzávěrky';

  @override
  String get monthlyClosingsOpenScreen => 'Otevřít';

  @override
  String get monthlyClosingsIntro =>
      'V uzavřeném kalendářním měsíci nelze vytvářet ani upravovat příjemky, výdejky, přesuny mezi sklady, inventuru, faktury, cenové nabídky ani související výrobní příkazy (podle data dokladu, data výroby nebo data na faktuře).';

  @override
  String get monthlyClosingsEmpty => 'Žádný uzavřený měsíc';

  @override
  String get monthlyClosingsCloseMonth => 'Uzavřít měsíc';

  @override
  String get monthlyClosingsReopenMonth => 'Znovu otevřít';

  @override
  String get monthlyClosingsClosedAt => 'Uzavřeno';

  @override
  String get monthlyClosingsBy => 'Kdo';

  @override
  String get monthlyClosingsAdminOnly =>
      'Měsíce může uzavírat a otevírat pouze administrátor.';

  @override
  String get monthlyClosingsPickMonth => 'Vyberte měsíc';

  @override
  String get monthlyClosingsNoteOptional => 'Poznámka (volitelné)';

  @override
  String monthlyClosingsConfirmReopen(String month) {
    return 'Znovu otevřít měsíc $month?';
  }

  @override
  String get monthlyClosingsAlreadyClosed => 'Tento měsíc je již uzavřen.';

  @override
  String get monthlyClosingsClosedSuccess => 'Měsíc byl uzavřen.';
}
