  ...
  void _showPermissionDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Pre skenovanie čiarových kódov je potrebný prístup ku kamere.'),
        actions: [
          TextButton(
      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.inventory_2_rounded, size: 60, color: Colors.blue),
              ...
              Text('Kód: $code', style: const TextStyle(fontSize: 16, color: Colors.grey)),
              const Divider(height: 32),
              const Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Na sklade:', style: TextStyle(fontSize: 18)),
                  Text('42 ks', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.green)),
                ],
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('SKENOVAŤ ĎALEJ', style: TextStyle(fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          ValueListenableBuilder(
            valueListenable: controller, // Controller sám o sebe slúži ako listenable
...
class ScannerOverlayPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(RRect.fromRectAndRadius(scanRect, const Radius.circular(12)), borderPaint);
  }
