...
class _FirstStartupScreenState extends State<FirstStartupScreen> {
  ...
  final TextEditingController _adminUsernameController = TextEditingController(text: 'admin');
  final TextEditingController _adminNameController = TextEditingController(text: 'Pavol Administrátor');
  final TextEditingController _adminPasswordController = TextEditingController();
  final TextEditingController _adminEmailController = TextEditingController(text: 'admin@stockpilot.sk');
  final TextEditingController _adminPhoneController = TextEditingController(text: '+421 ');
  final TextEditingController _adminDeptController = TextEditingController(text: 'Vedenie');
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final adminUser = User(
          ...
          avatarUrl: 'https://i.pravatar.cc/150?u=${_adminUsernameController.text}',
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.admin_panel_settings_rounded, size: 60, color: Colors.indigo),
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              validator: (v) => v!.isEmpty ? 'Zadajte email' : null,
                            ),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                      ...
                      const Align(
                        ...
                        child: Text("Úložisko databázy", style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: _isLoading 
                            ...
                            : const Text("DOKONČIŤ NASTAVENIE", style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                      ),
                    ],
                  ),
